    ...
    public class OrderHistoryService : IOrderHistoryService
    {
        ...
        private async Task HandleRollbackBusinessLogicAsync(HoaDon order, string oldStatus, string targetStatus)
        {
            ...
            switch (oldStatus)
            {
                ...
                case "Đang giao":
                    if (targetStatus == "Chờ lấy hàng")
                    {
                        _logger.LogInformation($"Rollback đơn hàng {order.IDHoaDon} từ 'Đang giao' về 'Chờ lấy hàng'");
                    }
                    break;
                ...
                case "Đã giao":
                    ...
                    {
                        _logger.LogInformation($"Rollback đơn hàng {order.IDHoaDon} từ 'Đã giao' về 'Đang giao'");
                    }
                    break;
            }
