...
namespace QuanApi.Controllers
{
    ...
    public class VaiTroController : ControllerBase
    {
        ...
        public VaiTroController(BanQuanAu1DbContext context) { _context = context; }

        // GET: api/VaiTroes
        [HttpGet]
        public async Task<ActionResult<IEnumerable<VaiTro>>> GetVaiTro() { return await _context.VaiTro.ToListAsync(); }
        ...
        private bool VaiTroExists(Guid id) { return _context.VaiTro.Any(e => e.IDVaiTro == id); }
    }
}
