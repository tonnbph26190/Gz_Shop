    ...
    public partial class init_db : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDChatLieu = table.Column<Guid>(type: "uuid", nullable: false),
                    MaChatLieu = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    TenChatLieu = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDDanhMuc = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDDotGiamGia = table.Column<Guid>(type: "uuid", nullable: false),
                    MaDot = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    TenDot = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDHoaTiet = table.Column<Guid>(type: "uuid", nullable: false),
                    MaHoaTiet = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    TenHoaTiet = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    NgayTao = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    NguoiTao = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    LanCapNhatCuoi = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    NguoiCapNhat = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaKhachHang = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDKichCo = table.Column<Guid>(type: "uuid", nullable: false),
                    MaKichCo = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    TenKichCo = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    NgayTao = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    NguoiTao = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    LanCapNhatCuoi = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    NguoiCapNhat = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDKieuDang = table.Column<Guid>(type: "uuid", nullable: false),
                    MaKieuDang = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    TenKieuDang = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    NgayTao = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    NguoiTao = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    LanCapNhatCuoi = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    NguoiCapNhat = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDLoaiOng = table.Column<Guid>(type: "uuid", nullable: false),
                    MaLoaiOng = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    TenLoaiOng = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    NgayTao = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    NguoiTao = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    LanCapNhatCuoi = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    NguoiCapNhat = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDLungQuan = table.Column<Guid>(type: "uuid", nullable: false),
                    MaLungQuan = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    TenLungQuan = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    NgayTao = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    NguoiTao = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    LanCapNhatCuoi = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    NguoiCapNhat = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDMauSac = table.Column<Guid>(type: "uuid", nullable: false),
                    MaMauSac = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    TenMauSac = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    NgayTao = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    NguoiTao = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    LanCapNhatCuoi = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    NguoiCapNhat = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDPhieuGiamGia = table.Column<Guid>(type: "uuid", nullable: false),
                    MaCode = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    TenPhieu = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: false),
                    GiaTriGiam = table.Column<int>(type: "integer", nullable: false),
                    GiaTriGiamToiDa = table.Column<decimal>(type: "numeric", nullable: true),
                    DonToiThieu = table.Column<decimal>(type: "numeric", nullable: true),
                    SoLuong = table.Column<short>(type: "smallint", nullable: false),
                    LaCongKhai = table.Column<bool>(type: "boolean", nullable: false),
                    NgayBatDau = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    NgayKetThuc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    NgayTao = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    NguoiTao = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDPhuongThucThanhToan = table.Column<Guid>(type: "uuid", nullable: false),
                    MaPhuongThuc = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    TenPhuongThuc = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDThuongHieu = table.Column<Guid>(type: "uuid", nullable: false),
                    MaThuongHieu = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDVaiTro = table.Column<Guid>(type: "uuid", nullable: false),
                    MaVaiTro = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    TenVaiTro = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    NgayTao = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    NguoiTao = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    LanCapNhatCuoi = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    NguoiCapNhat = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDDiaChi = table.Column<Guid>(type: "uuid", nullable: false),
                    MaDiaChi = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    IDKhachHang = table.Column<Guid>(type: "uuid", nullable: false),
                    DiaChiChiTiet = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    LaMacDinh = table.Column<bool>(type: "boolean", nullable: false),
                    TenNguoiNhan = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    SdtNguoiNhan = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    NgayTao = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    NguoiTao = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    LanCapNhatCuoi = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    NguoiCapNhat = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDGioHang = table.Column<Guid>(type: "uuid", nullable: false),
                    MaGioHang = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDKhachHangPhieuGiam = table.Column<Guid>(type: "uuid", nullable: false),
                    MaKhachHangPhieuGiam = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    IDKhachHang = table.Column<Guid>(type: "uuid", nullable: false),
                    IDPhieuGiamGia = table.Column<Guid>(type: "uuid", nullable: false),
                    SoLuong = table.Column<int>(type: "integer", nullable: false),
                    SoLuongDaSuDung = table.Column<int>(type: "integer", nullable: false),
                    NgayTao = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    NguoiTao = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    LanCapNhatCuoi = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    NguoiCapNhat = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IDKieuDang = table.Column<Guid>(type: "uuid", nullable: false),
                    IDLungQuan = table.Column<Guid>(type: "uuid", nullable: false),
                    CoXepLy = table.Column<bool>(type: "boolean", nullable: false),
                    CoGian = table.Column<bool>(type: "boolean", nullable: false),
                    NgayTao = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    NguoiTao = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    LanCapNhatCuoi = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    NguoiCapNhat = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaNhanVien = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    TenNhanVien = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    Email = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    MatKhau = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    ...
                    QueQuan = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    ...
                    NguoiCapNhat = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    TrangThai = table.Column<bool>(type: "boolean", nullable: false),
                    IDVaiTro = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDSanPhamChiTiet = table.Column<Guid>(type: "uuid", nullable: false),
                    MaSPChiTiet = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    IDSanPham = table.Column<Guid>(type: "uuid", nullable: false),
                    IDKichCo = table.Column<Guid>(type: "uuid", nullable: false),
                    IDMauSac = table.Column<Guid>(type: "uuid", nullable: false),
                    IDDotGiamGia = table.Column<Guid>(type: "uuid", nullable: true),
                    IDHoaTiet = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDHoaDon = table.Column<Guid>(type: "uuid", nullable: false),
                    MaHoaDon = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    IDKhachHang = table.Column<Guid>(type: "uuid", nullable: true),
                    IDNhanVien = table.Column<Guid>(type: "uuid", nullable: true),
                    IDPhieuGiamGia = table.Column<Guid>(type: "uuid", nullable: true),
                    IDPhuongThucThanhToan = table.Column<Guid>(type: "uuid", nullable: false),
                    TongTien = table.Column<decimal>(type: "numeric", nullable: false),
                    TienGiam = table.Column<decimal>(type: "numeric", nullable: true),
                    PhiVanChuyen = table.Column<decimal>(type: "numeric", nullable: true),
                    TrangThai = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    TenNguoiNhan = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    SoDienThoaiNguoiNhan = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    DiaChiGiaoHang = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    NgayTao = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    NguoiTao = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    LanCapNhatCuoi = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    NguoiCapNhat = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    LyDoHuyDon = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    TrangThaiHoaDon = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDPhongTroChuyen = table.Column<Guid>(type: "uuid", nullable: false),
                    MaPhongTroChuyen = table.Column<string>(type: "text", nullable: false),
                    IDKhachHang = table.Column<Guid>(type: "uuid", nullable: false),
                    IDNhanVien = table.Column<Guid>(type: "uuid", nullable: false),
                    NgayTao = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDAnhSanPham = table.Column<Guid>(type: "uuid", nullable: false),
                    MaAnh = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    IDSanPhamChiTiet = table.Column<Guid>(type: "uuid", nullable: false),
                    UrlAnh = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDChiTietGioHang = table.Column<Guid>(type: "uuid", nullable: false),
                    MaChiTietGioHang = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    IDGioHang = table.Column<Guid>(type: "uuid", nullable: false),
                    IDSanPhamChiTiet = table.Column<Guid>(type: "uuid", nullable: false),
                    SoLuong = table.Column<int>(type: "integer", nullable: false),
                    GiaBan = table.Column<decimal>(type: "numeric", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDSanPhamDotGiam = table.Column<Guid>(type: "uuid", nullable: false),
                    MaSanPhamDotGiam = table.Column<string>(type: "text", nullable: false),
                    IDSanPhamChiTiet = table.Column<Guid>(type: "uuid", nullable: false),
                    IDDotGiamGia = table.Column<Guid>(type: "uuid", nullable: false),
                    NgayTao = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    GiaGoc = table.Column<decimal>(type: "numeric", nullable: false),
                    NguoiTao = table.Column<string>(type: "text", nullable: true),
                    LanCapNhatCuoi = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    NguoiCapNhat = table.Column<string>(type: "text", nullable: true),
                    TrangThai = table.Column<bool>(type: "boolean", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDChiTietHoaDon = table.Column<Guid>(type: "uuid", nullable: false),
                    MaChiTietHoaDon = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    IDHoaDon = table.Column<Guid>(type: "uuid", nullable: false),
                    IDSanPhamChiTiet = table.Column<Guid>(type: "uuid", nullable: false),
                    SoLuong = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDLichSuHoaDon = table.Column<Guid>(type: "uuid", nullable: false),
                    MaLichSuHoaDon = table.Column<string>(type: "text", nullable: false),
                    IDHoaDon = table.Column<Guid>(type: "uuid", nullable: false),
                    ...
                    LanCapNhatCuoi = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    NguoiCapNhat = table.Column<string>(type: "text", nullable: true),
                    TrangThaiLichSu = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDTinNhan = table.Column<Guid>(type: "uuid", nullable: false),
                    MaTinNhan = table.Column<string>(type: "text", nullable: false),
                    IDPhongTroChuyen = table.Column<Guid>(type: "uuid", nullable: false),
                    IDKhachHang = table.Column<Guid>(type: "uuid", nullable: true),
                    IDNhanVien = table.Column<Guid>(type: "uuid", nullable: true),
